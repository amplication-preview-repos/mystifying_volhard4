...
@InputType()
class CustomerOrderCreateNestedManyWithoutUsersInput {
...
export { CustomerOrderCreateNestedManyWithoutUsersInput as CustomerOrderCreateNestedManyWithoutUsersInput };
