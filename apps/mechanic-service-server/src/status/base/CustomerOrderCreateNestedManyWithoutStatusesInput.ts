...
@InputType()
class CustomerOrderCreateNestedManyWithoutStatusesInput {
...
export { CustomerOrderCreateNestedManyWithoutStatusesInput as CustomerOrderCreateNestedManyWithoutStatusesInput };
