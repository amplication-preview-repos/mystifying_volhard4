...
@InputType()
class CustomerOrderCreateNestedManyWithoutServicesInput {
...
export { CustomerOrderCreateNestedManyWithoutServicesInput as CustomerOrderCreateNestedManyWithoutServicesInput };
