...
@InputType()
class CustomerOrderCreateNestedManyWithoutMontirsInput {
...
export { CustomerOrderCreateNestedManyWithoutMontirsInput as CustomerOrderCreateNestedManyWithoutMontirsInput };
